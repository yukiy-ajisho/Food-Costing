-- =========================================================
-- PostgreSQL関数: calculate_item_costs
-- =========================================================
-- アイテムのコストを計算するPostgreSQL関数
-- test_calculate_item_costs.sqlをベースに作成
-- =========================================================
-- 機能:
-- - Prepped Itemsのコストを計算（ループで依存関係を解決）
-- - Raw Itemのコストは、各recipe_lineごとにspecific_childを考慮して計算
-- - Express側の実装と一致させる
-- =========================================================
