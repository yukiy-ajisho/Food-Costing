-- =========================================================
-- Test: calculate_item_costs_with_breakdown function
-- =========================================================
-- This script tests the calculate_item_costs_with_breakdown function
-- to ensure it works correctly with the provided code

-- =========================================================
-- Step 1: Create or replace the function with your code
-- =========================================================
...
-- 関数をテスト（上記で取得したuser_idの1つを使用）
-- 注意: 実際のuser_idに置き換えてください
-- SELECT * FROM calculate_item_costs_with_breakdown('YOUR_USER_ID_HERE'::uuid);

-- =========================================================
-- Step 3: より詳細なテスト（特定のuser_idで）
-- =========================================================
-- 以下のクエリで、特定のuser_idのデータが存在するか確認
-- SELECT COUNT(*) as items_count FROM items WHERE user_id = 'YOUR_USER_ID_HERE'::uuid;
-- SELECT COUNT(*) as raw_items_count FROM items WHERE user_id = 'YOUR_USER_ID_HERE'::uuid AND item_kind = 'raw';
-- SELECT COUNT(*) as prepped_items_count FROM items WHERE user_id = 'YOUR_USER_ID_HERE'::uuid AND item_kind = 'prepped';
