...
-- 既存の関数を削除
DROP FUNCTION IF EXISTS calculate_item_costs_with_breakdown();

-- 新しい関数を作成（p_user_idパラメータ付き、元のロジックを保持）
...
-- テスト: 関数が正しく動作するか確認
-- =========================================================
-- 以下のクエリで関数をテストできます（user_idを指定）
-- SELECT * FROM calculate_item_costs_with_breakdown('e0aa9464-3027-4dcc-a655-4b329be44fdb'::uuid);
