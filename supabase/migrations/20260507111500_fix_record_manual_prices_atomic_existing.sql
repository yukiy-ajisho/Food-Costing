-- Fix: Ensure bulk manual price recording inserts purchase-qty fields for existing VVPs.
-- This satisfies price_events CHECK constraint: pe_purchase_qty_not_all_null.
