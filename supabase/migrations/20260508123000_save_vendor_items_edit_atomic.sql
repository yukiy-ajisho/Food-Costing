-- Atomic Vendor Items (Edit mode) save: VVP field updates + optional product_mapping
-- replace, and new rows (VVP + mapping + initial price_event). All-or-nothing per RPC.
-- Deprecation stays in application layer (PATCH .../deprecate) after a successful RPC.
