      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={content}>
            <Heading style={heading}>You've been invited as a director</Heading>
            <Text style={paragraph}>
              <strong>{inviterName}</strong> has invited you to join{" "}
              <strong>{companyName}</strong> on Food Costing as a{" "}
              <strong>director</strong>.
            </Text>
            <Text style={paragraph}>
              As a director, you can create and manage tenants (locations) under
              this company. Click the button below to accept the invitation:
            </Text>
